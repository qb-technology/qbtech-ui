...
const {
  ...
  ui: props_ui,
  user = { name: 'Andrews Boateng', position: 'Manager', image: 'https://avatars.githubusercontent.com/u/739984?v=4', userMenu },
} = defineProps<qbFrontendSidebarType>()

const default_props = {
  ui: {
    base: 'relative',
    container: 'h-full grid grid-rows-[48px_minmax(0,1fr)_auto]',
    padding: '',
    background: '',
    rounded: '',
    header: {
...
<template>
  <div :class="[ui._base, ui._container, ui._background, ui._padding]">
    <div :class="[ui._header]">
      <slot name="header">
